...
# Amazon Camping Accessories URL
url = "https://www.amazon.in/s?k=camping+accessories"
driver.get(url)
time.sleep(5)
...
df.to_csv("camping_accessories.csv", index=False)
print("✅ Camping Accessories data saved to camping_accessories.csv")
