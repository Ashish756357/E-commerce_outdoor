...
# Amazon Sleeping Bags URL
url = "https://www.amazon.in/s?k=sleeping+bag"
driver.get(url)
time.sleep(5)
...
df.to_csv("sleeping_bags.csv", index=False)
print("✅ Sleeping Bags data saved to sleeping_bags.csv")
